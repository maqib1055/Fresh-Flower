...
<body>
                ...
                <div class="col-lg-6 offset-lg-3 col-md-8 offset-md-2 col-custom">
                    <div class="login-register-wrapper">
                        ...
                        <form action="#" method="post">
                            ...
                            <div class="single-input-item mb-3">
                                <input type="password" placeholder="Conform Password" name="c_password">
                            </div>
                            <div class="single-input-item mb-3">
                            ...
                            <div class="single-input-item mb-3">
                                <button type="submit" name="register" class="btn flosun-button secondary-btn theme-color rounded-0">Register</button>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    if(isset($_POST['register'])){
        ...
        $sql = "INSERT INTO `register`(`user_name`, `user_email`, `user_password`, `c_password`, `roletype`) VALUES ('$name','$email','$n_password','$c_password','2')";
